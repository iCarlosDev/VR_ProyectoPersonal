	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 FinalHeight184 = ( inputMesh.normalOS * ( Height188 - _ZeroHeightOffset ) );
				...
				#endif
				float3 vertexValue = ( ( ( ( _PrimaryAmplitude * tex2Dlod( _Noise, float4( frac( ( ( ( _PrimaryNoiseTiling * appendResult140 * 0.01 ) + ( _TimeParameters.x * _PrimarySpeed ) ) + inputMesh.ase_color.r ) ), 0, 0.0) ) ) + ( tex2Dlod( _Noise, float4( frac( ( ( ( 0.01 * appendResult140 * _SecondaryNoiseTiling ) + ( _TimeParameters.x * _SecondarySpeed * -1.0 ) ) + inputMesh.ase_color.r ) ), 0, 0.0) ) * _SecondaryAmplitude ) ) * inputMesh.ase_color.a ) + float4( FinalHeight184 , 0.0 ) ).rgb;
						...
						)
			{
				...
				surfaceDescription.Normal = unpack6;
				...
				surfaceDescription.Smoothness = ( tex2DNode5.a * _GlossMapScale );
				surfaceDescription.Occlusion = saturate( ( tex2DNode5.g + ( 1.0 - _OcclusionStrength ) ) );
...
/*ASEBEGIN
Version=18935
390;198;1830;1025;-507.8126;109.159;1.040164;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-1871.421,921.6698;Float;False;Property;_SecondarySpeed;Secondary Speed;11;0;Create;True;0;0;0;False;0;False;0.5;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-1854.104,390.8951;Inherit;False;Property;_SecondaryNoiseTiling;Secondary Noise Tiling;9;0;Create;True;0;0;0;False;0;False;8;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-1885.804,734.047;Float;False;Property;_PrimarySpeed;Primary Speed;10;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-1849.567,-54.93539;Inherit;False;Property;_PrimaryNoiseTiling;Primary Noise Tiling;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;186;319.3386,740.6695;Inherit;False;Property;_Height;Height;14;0;Create;True;0;0;0;False;0;False;1;0.063;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;192;501.1051,1978.792;Inherit;False;Property;_ZeroHeightOffset;Zero Height Offset;15;0;Create;True;0;0;0;False;0;False;0;0;-0.2;0.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;185;496.0362,1740.694;Inherit;False;188;Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;156;-1345.197,-309.6911;Inherit;True;Property;_Noise;Noise;7;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;111;-900.8907,637.7394;Inherit;False;Property;_SecondaryAmplitude;Secondary Amplitude;13;0;Create;True;0;0;0;False;0;False;0;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-778.231,-356.0507;Inherit;False;Property;_PrimaryAmplitude;Primary Amplitude;12;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;154;-921.3699,14.42983;Inherit;True;Property;_Noise_A;Noise_A;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;173;793.9244,293.9795;Inherit;False;Property;_OcclusionStrength;Occlusion Strength;4;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;167;-173.8853,-117.8056;Inherit;False;Property;_NormalScale;Normal Scale;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;165;-196.0023,-382.6207;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;163;793.2899,194.9346;Inherit;False;Property;_GlossMapScale;Smoothness;3;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;164;1271.115,133.9832;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;207;1;6;0
WireConnection;207;4;5;1
WireConnection;207;7;164;0
WireConnection;207;8;180;0
WireConnection;207;9;1;4
WireConnection;207;11;190;0
ASEEND*/
//CHKSM=2730E7C35F3F1C6E5BF14F7842672A42D28DDC0F